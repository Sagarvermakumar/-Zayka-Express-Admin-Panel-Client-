...
const DeleteUserProfileModal = ({ isOpen, onClose, onDelete, userName }) => {
    ...
    return (
        <Modal isOpen={isOpen} onClose={handleClose} isCentered>
            ...
            <ModalContent
                ...
                <ModalBody  >
                    <Text mb={2}>
                        To delete the profile, type the user's name: <b style={{ color: "#f20", fontWeight: 500, fontFamily: "sans-serif" }}>{userName}</b>
                    </Text>
                    <Input
                        my={4}
