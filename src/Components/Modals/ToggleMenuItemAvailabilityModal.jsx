    ...
    <Modal isOpen={isOpen} onClose={onClose} isCentered>
        ...
        <ModalBody px={6} py={8}>
          <Select
            ...
            _focusVisible={{ borderColor: "red.500", boxShadow: "0 0 0 1px red.500" }}
          >
            <option style={{ backgroundColor: "#1A202C", color: "white" }} value="available">
              Available
            </option>
            <option style={{ backgroundColor: "#1A202C", color: "white" }} value="unavailable">
              Unavailable
            </option>
          </Select>
        </ModalBody>
